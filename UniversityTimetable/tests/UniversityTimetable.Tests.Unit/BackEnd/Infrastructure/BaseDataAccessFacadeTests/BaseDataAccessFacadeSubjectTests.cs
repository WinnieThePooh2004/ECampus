...
public sealed class BaseDataAccessFacadeSubjectTests : BaseDataAccessFacadeTests<Subject>, IClassFixture<SubjectFactory>
{
    ...
    public BaseDataAccessFacadeSubjectTests(SubjectFactory dataFactory) : base(dataFactory)
    {
    }
}