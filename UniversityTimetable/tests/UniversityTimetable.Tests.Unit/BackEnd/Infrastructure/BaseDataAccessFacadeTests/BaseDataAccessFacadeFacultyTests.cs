...
public sealed class BaseDataAccessFacadeFacultyTests : BaseDataAccessFacadeTests<Faculty>, IClassFixture<FacultyFactory>
{
    ...
    public BaseDataAccessFacadeFacultyTests(FacultyFactory dataFactory) : base(dataFactory)
    {
