...
public sealed class BaseDataAccessFacadeUserTests : BaseDataAccessFacadeTests<User>, IClassFixture<UserFactory>
{
    ...
    public BaseDataAccessFacadeUserTests(UserFactory dataFactory) : base(dataFactory)
    {
    }
}