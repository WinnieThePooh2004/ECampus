...
public sealed class BaseRepositoryDepartmentTests : BaseRepositoryTests<Department>, IClassFixture<DepartmentFactory>
{
    ...
    public BaseRepositoryDepartmentTests(DepartmentFactory dataFactory) : base(dataFactory)
    {
    }
}