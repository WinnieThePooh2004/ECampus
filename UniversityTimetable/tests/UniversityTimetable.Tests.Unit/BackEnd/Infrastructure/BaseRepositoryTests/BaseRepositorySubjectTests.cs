...
public sealed class BaseRepositorySubjectTests : BaseRepositoryTests<Subject>, IClassFixture<SubjectFactory>
{
    ...
    public BaseRepositorySubjectTests(SubjectFactory dataFactory) : base(dataFactory)
    {
    }
}