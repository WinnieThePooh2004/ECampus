...
public sealed class SingleItemSelectorGroupTests : SingleItemSelectorTests<Group>, IClassFixture<GroupFactory>
{
    public SingleItemSelectorGroupTests(GroupFactory dataFactory) : base(dataFactory)
    {
    }
