...
public sealed class SingleItemSelectorDepartmentTests : SingleItemSelectorTests<Department>, IClassFixture<DepartmentFactory>
{
    public SingleItemSelectorDepartmentTests(DepartmentFactory dataFactory) : base(dataFactory)
    {
