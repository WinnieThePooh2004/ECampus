...
namespace UniversityTimetable.Tests.Unit.BackEnd.Infrastructure.AuthorizationDataAccess;

public class AuthorizationDataAccessTests
{
    private readonly UniversityTimetable.Infrastructure.Auth.AuthorizationDataAccess _sut;
    private readonly ApplicationDbContext _context = Substitute.For<ApplicationDbContext>();

    public AuthorizationDataAccessTests()
    {
        _sut = new UniversityTimetable.Infrastructure.Auth.AuthorizationDataAccess(_context);
    }
