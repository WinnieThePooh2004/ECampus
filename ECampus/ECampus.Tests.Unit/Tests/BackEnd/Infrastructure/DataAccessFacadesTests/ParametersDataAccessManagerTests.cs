...
namespace ECampus.Tests.Unit.Tests.BackEnd.Infrastructure.DataAccessFacadesTests;

public class ParametersDataAccessManagerTests
{
    private readonly IDataAccessFacade _sut;
    ...
    {
        _sut = new DataAccessFacade(_context, _serviceProvider);
    }
