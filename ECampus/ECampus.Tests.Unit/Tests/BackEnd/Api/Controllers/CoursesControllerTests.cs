...
{
    private readonly IParametersService<MultipleCourseResponse, CourseParameters> _service =
        Substitute.For<IParametersService<MultipleCourseResponse, CourseParameters>>();
